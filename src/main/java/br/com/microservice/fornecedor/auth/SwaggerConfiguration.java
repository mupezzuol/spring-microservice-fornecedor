package br.com.microservice.fornecedor.auth;
...
public class SwaggerConfiguration {
	...
	public Docket forumApi() {
		return new Docket(DocumentationType.SWAGGER_2)
				.select()
				.apis(RequestHandlerSelectors.basePackage("br.com.microservice.fornecedor.controller"))
	...
	private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
        	.title("Spring Microservice - Fornecedor API")
            ...
            .licenseUrl("https://github.com/mupezzuol/spring-microservice-fornecedor")
            .version("1.0.0")
            .build();
    }
